...
class vic_procedural_lantern_live_panel(bpy.types.Panel):
    bl_category = "Vic Addons"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_label = "Procedrual Lantern"
    ...
    def draw(self, context):
        ...
        col.operator(vic_procedural_lantern_proxy.bl_idname)
        col.operator(vic_procedural_lantern_connect.bl_idname)
        col.operator(vic_procedural_lantern.bl_idname)
